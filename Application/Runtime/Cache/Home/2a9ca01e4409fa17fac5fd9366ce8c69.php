...
<meta http-equiv="description" content="<?php echo ($company1["cm_keys"]); ?>">
<meta name="keywords" content="<?php echo ($company1["cm_keys"]); ?>" />
    ...
    <div class="cIn clearfix">
      ...
      <div class="ciRight gongsijianjie current">
       		<div class="cirHead clearfix">
            	<h3><?php echo ($company1["cm_name"]); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="index.html"><?php echo (L("home")); ?></a>><a href="/index.php/Home/Company/index.html"><?php echo (L("guanyu")); ?></a>><a href="/index.php/Home/Company/detail/cmid/<?php echo ($company1["cm_id"]); ?>.html"><?php echo ($company1["cm_name"]); ?></a></p>
          	</div>
            <div class="text">
            <?php echo ($company1["cm_content"]); ?>
            </div>
        </div>
        <!--ciRight-->
