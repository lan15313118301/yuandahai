...
<section>
  ...
  <div class="screening-content">
    <ul class="sc-ul">
      <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><li class="sc-li"> <a  href="/index.php/Home/Product/index/cid/<?php echo ($v["c_id"]); ?>.html" title="<?php echo ($v["c_name"]); ?>" class="sc-a"><?php echo (cutstr($v["c_name"],21)); ?></a> </li><?php endforeach; endif; ?>	
    </ul>
  </div>
  <!--护肤需求筛选-->
    ...
    <ul>
    	<?php if(is_array($product)): foreach($product as $key=>$v): ?><li><a href="/index.php/Home/Product/prodisplay/pid/<?php echo ($v["p_id"]); ?>.html">
                    	<img src="/Public/images/<?php echo ($v["p_picture"]); ?>" width='301' height='225'>
                     	<span style="width:100%; float:left; color:#333; text-align:center"><?php echo ($v["p_name"]); ?> </span> 
                    </a></li><?php endforeach; endif; ?> 
    </ul>
  </div>
  <div class="page" style="float:left; width:100%; text-align:center">
