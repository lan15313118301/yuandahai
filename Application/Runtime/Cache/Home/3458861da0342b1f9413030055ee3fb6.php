        ...
        <div class="tRight">
            ...
            <div class="nav">
                <ul class="clearfix">
                    ...
                    <li class="current differ"><a href="/index.php/Home/Product/index/cid/8.html"><?php echo (L("chanpin")); ?></a></li>
...
<div class="content">
    ...
    <div class="cIn clearfix">
   	  <div class="ciLeft">
            ...
            <div class="fenlei">
           	  <ul>
           	  <?php if(is_array($cate)): foreach($cate as $key=>$v): if($language == 'en-us'): ?><li style="text-align:left;"><a style="margin-left:20px;" href="/index.php/Home/Product/index/cid/<?php echo ($v["c_id"]); ?>.html" title="<?php echo ($v["c_name"]); ?>"><?php echo (cutstr($v["c_name"],21)); ?></a></li>
                <?php else: ?>
        ...
        <div class="ciRight">
        	<div class="cirHead clearfix">
            	<h3 title="<?php echo ($product[0]["c_name"]); ?>"><?php echo (cutstr($product[0]["c_name"],25)); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="/index.php/Home/Index/index.html"><?php echo (L("home")); ?></a>><a href="/index.php/Home/Product/index.html"><?php echo (L("productcenter")); ?></a>><a href="javascript:;" title="<?php echo ($product[0]["c_name"]); ?>"><?php echo (cutstr($product[0]["c_name"],21)); ?></a></p>
            </div>

            <div class="showLine clearfix">
            	<ul class="clearfix">
            	<?php if(is_array($product)): foreach($product as $key=>$v): ?><li><a href="/index.php/Home/Product/prodisplay/pid/<?php echo ($v["p_id"]); ?>.html">
                    	<img src="/Public/images/<?php echo ($v["p_picture"]); ?>" width='301' height='225'>
                     	<span><?php echo ($v["p_name"]); ?> </span> 
                    </a></li><?php endforeach; endif; ?>  
                </ul>
            </div>
            <!--页数-->
            <div class="page">
           		<span id="xianpage"><?php echo ($fangkuai); ?></span>
                <span><?php echo ($showMsg); ?></span>
          </div>
