...
<head>
<meta charset="utf-8">
<title><?php echo (L("title")); ?>-<?php echo (L("renli")); ?></title>
<meta http-equiv="description" content="<?php echo ($rencai["q_keys"]); ?>">
<meta name="keywords" content="<?php echo ($rencai["q_keys"]); ?>" />
<link href="/Public/qiancss/common.css" type="text/css" rel="stylesheet"/>
<link href="/Public/qiancss/CompanyQualification.css" type="text/css" rel="stylesheet"/>
        ...
        <div class="tRight">
            ...
            <div class="nav">
                <ul class="clearfix">
                    ...
                    <li class="current differ"><a href="/index.php/Home/Emyployee/index.html"><?php echo (L("renli")); ?></a></li>
...
<div class="content">
	<!--——————banner 开始——————-->
    <div class="banner">
    	<img src="/Public/img/zhaopinBanner.png"/>
    </div>
    <!--——————banner 结束——————-->
    ...
    <div class="cIn clearfix">
   	  <div class="ciLeft">
        	<div class="cilTop">
            	<h3><?php echo (L("rencaizhaopin")); ?></h3>
            </div>
            <div class="fenlei">
           	  <ul>
                	<li><a href="/index.php/Home/Emyployee/index.html"><?php echo (L("rencailinian")); ?> </a></li>
                	<li><a href="javascript:"><?php echo (L("zhaopinxinxi")); ?></a></li>
                </ul>
            </div>
      ...
      <div class="ciRight gongsijianjie current">
       		<div class="cirHead clearfix">
            	<h3><?php echo (L("rencailinian")); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="/index.php/Home/Index/index.html"><?php echo (L("home")); ?></a>><a href="/index.php/Home/Emyployee/index.html"><?php echo (L("rencaizhaopin")); ?></a>><a href="javascript:;"><?php echo (L("rencailinian")); ?></a></p>
          	</div>
            <div class="text clearfix">
            	<div class="center">
                   <?php echo ($rencai["q_content"]); ?>
                </div>
        </div>
        	<div class="qi">
          	<img src="/Public/img/zhaopinimg01.png"/>
            </div>
        </div>
        <!--ciRight-->
        ...
        <div class="ciRight qiyeweenhua">
       		<div class="cirHead clearfix">
            	<h3><?php echo (L("zhaopinxinxi")); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="/index.php/Home/Index/index.html"><?php echo (L("home")); ?></a>><a href="/index.php/Home/Emyployee/index.html"><?php echo (L("rencaizhaopin")); ?></a>><a href="javascript:;"><?php echo (L("zhaopinxinxi")); ?></a></p>
          	</div>
            <div class="text">
            	<p class="blue"><?php echo (L("zhaopinzhuanxian")); ?>：<?php echo ($contact["l_zhaopin"]); ?></p>
                <ul>
                <?php if(is_array($zhaopin)): foreach($zhaopin as $key=>$v): ?><li>
                    	<p class="biaoti"><?php echo ($v["j_name"]); ?></p>
                        <i class="arrow"></i>
                        <div class="zhankai current">
                        	<?php echo ($v["j_content"]); ?>
                        </div>
