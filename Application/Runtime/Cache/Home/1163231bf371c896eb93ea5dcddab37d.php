...
<head>
<meta charset="utf-8">
<title><?php echo (L("title")); ?>-<?php echo (L("chanpin")); ?></title>
<meta http-equiv="description" content="<?php echo ($product["p_keys"]); ?>">
<meta name="keywords" content="<?php echo ($product["p_keys"]); ?>" />
<link href="/public/qiancss/common.css" rel="stylesheet" type="text/css"/>
<link href="/public/qiancss/newsCopy.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="tRight">
            ...
            <div class="nav">
               <ul class="clearfix">
                    ...
                    <li class="current differ"><a href="/index.php/Home/Product/index.html"><?php echo (L("chanpin")); ?></a></li>
...
<div class="content">
	<!--——————banner 开始——————-->
    <div class="banner">
    	<img src="/public/img/chanpinbanner.png"/>
    </div>
    <!--——————banner 结束——————-->
    ...
    <div class="cIn clearfix">
   	  <div class="ciLeft">
        	<div class="cilTop">
            	<h3><?php echo (L("productcenter")); ?></h3>
            </div>
            <div class="fenlei">
           	  <ul>
           	  <?php if(is_array($cate2)): foreach($cate2 as $key=>$v): if($language == 'en-us'): ?><li style="text-align:left;"><a style="margin-left:20px;" href="/index.php/Home/Product/index/cid/<?php echo ($v["c_id"]); ?>.html" title="<?php echo ($v["c_name"]); ?>"><?php echo (cutstr($v["c_name"],21)); ?></a></li>
                <?php else: ?>
                	<li><a href="/index.php/Home/Product/index/cid/<?php echo ($v["c_id"]); ?>.html"><?php echo ($v["c_name"]); ?></a></li><?php endif; endforeach; endif; ?>	
                </ul>
            </div>
        ...
        <div class="ciRight">
        	<div class="cirHead clearfix">
            	<h3 title="<?php echo ($product["c_name"]); ?>"><?php echo (cutstr($product["c_name"],25)); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="/index.php/Index/index.html"><?php echo (L("home")); ?></a>><a href="/index.php/Product/index.html"><?php echo (L("productcenter")); ?></a>><a href="/index.php/Product/index/cid/<?php echo ($product["c_id"]); ?>.html" title="<?php echo ($product["c_name"]); ?>"><?php echo (cutstr($product["c_name"],25)); ?></a></p>
            </div>

            <div class="showLine clearfix" style="text-align:center">
            	<h1><?php echo ($product["p_name"]); ?></h1><br/>
           		<p style='color:gray'><?php echo (L("time")); ?>：<?php echo (date('Y-m-d',$product["p_time"])); ?>&nbsp;&nbsp;<?php echo (L("click")); ?>：<?php echo ($product["p_click"]); ?></p>
                <p class="lastP"><?php echo ($product["p_content"]); ?></p>
            </div>
