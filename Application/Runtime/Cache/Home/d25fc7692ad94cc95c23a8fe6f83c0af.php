...
<head>
<meta charset="utf-8">
<title><?php echo (L("title")); ?>-<?php echo (L("xiaoshou")); ?></title>
<meta http-equiv="description" content="<?php echo ($sale["q_keys"]); ?>">
<meta name="keywords" content="<?php echo ($sale["q_keys"]); ?>" />
        ...
        <div class="tRight">
            ...
            <div class="nav">
                <ul class="clearfix">
                    ...
                    <li class="current differ"><a href="/index.php/Home/Sale/index.html"><?php echo (L("xiaoshou")); ?></a></li>
...
<div class="content">
	<!--——————banner 开始——————-->
    <div class="banner">
    	<img src="/Public/img/xiaoshoubanner.png"/>
    </div>
    <!--——————banner 结束——————-->
    ...
    <div class="cIn clearfix">
        ...
        <div class="ciRight">
        	<div class="cirHead clearfix">
            	<h3><?php echo (L("xiaoshouwangge")); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="index.html"><?php echo (L("home")); ?></a>><a href="news.html"><?php echo (L("xiaoshouwangge")); ?></a></p>
            </div>

            <div class="showLine clearfix">
            	<?php echo ($sale["q_content"]); ?>
	        </div>
