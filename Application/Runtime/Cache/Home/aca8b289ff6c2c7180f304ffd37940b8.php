...
<meta http-equiv="description" content="<?php echo ($detailnews["n_kyes"]); ?>">
<meta name="keywords" content="<?php echo ($detailnews["n_keys"]); ?>" />
        ...
        <div class="tRight">
            ...
            <div class="nav">
               	<ul class="clearfix">
                    ...
                    <li><a href="/index.php/Home/Product/index.html"><?php echo (L("chanpin")); ?></a></li>
    ...
    <div class="cIn clearfix">
        ...
        <div class="ciRight">
        	<div class="cirHead clearfix">
            	<h3><?php echo ($detailnews["n_cate"]); ?></h3>
                <p><?php echo (L("current")); ?>：<a href="/index.php/Home/Index/index.html"><?php echo (L("home")); ?></a>><a href="/index.php/Home/News/index.html"><?php echo (L("xinwen")); ?></a>><a href="javascript:;"><?php echo ($detailnews["n_cate"]); ?></a></p>
            </div>

            <div class="showLine clearfix">
            	<div class="text" style="text-align:center;">
            		<h1><?php echo ($detailnews["n_title"]); ?></h1><br/>
            		<p style='color:gray'><?php echo (L("fabushijian")); ?>：<?php echo (date('Y-m-d',$detailnews["n_time"])); ?>&nbsp;&nbsp;<?php echo (L("clicktimes")); ?>：<?php echo ($detailnews["n_click"]); ?></p><br/>
           			<p align="left"><?php echo ($detailnews["n_content"]); ?></p> 
            </div>
            </div>
