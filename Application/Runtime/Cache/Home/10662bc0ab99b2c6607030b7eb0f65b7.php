...
<div class="b-main">
  <h3>最新动态</h3>
  <ul>
  	  <?php if(is_array($news)): foreach($news as $key=>$v): ?><li><a href="/index.php/Home/News/detail/nid/<?php echo ($v["n_id"]); ?>.html"> <img src="/Public/images/<?php echo ($v["n_picture"]); ?>" width="218" height="152">
      <h3><?php echo (cutstr($v["n_title"],20)); ?> </h3>
      <p class="contentbox"><?php echo (cutstr($v["n_info"],110)); ?> </p>
