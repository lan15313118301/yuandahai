	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
					...
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Addnews/add.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>所属分类：</td>
								<td colspan='2'>
							...
							<tr align="left">
								<td>关键字：</td>
								<td colspan='2'><input type="text" size="50" name="n_keys"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr align="left">
								<td>文章标题：</td>
								<td colspan='2'><input type="text" size="50" name="n_title"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>新闻(简介)：</td>
								<td colspan='2'><textarea cols='60' rows='1' name="n_info"></textarea><font color='red'>必填</font></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr>
								<td>文章内容：</td>
								<td colspan='2'><textarea name="n_content"></textarea></td>
							</tr>
							<tr>
								<td colspan='3'>&nbsp;</td>
							</tr>
							...
							<tr align="left">
								<td>Englist标题：</td>
								<td colspan='2'><input type="text" size="50" name="enn_title"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>Englist(简介)：</td>
								<td colspan='2'><textarea cols='60' rows='1' name="enn_info"></textarea><font color='red'>必填</font></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr>
								<td>Englist内容：</td>
								<td colspan='2'><textarea name="enn_content"></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'><input type="submit" value="添加新闻"/>&nbsp;&nbsp;<input onclick="clickform()" type="button" value="重新填写"/></td>
							</tr>
						</table>
						</form>
				    </div>
