	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
					...
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Addbanner/add.html" method="post" enctype="multipart/form-data">
						<table>
							<tr align="left">
								<td>首页大图上传(中文版)：</td>
							...
							<tr>
								...
								<td colspan='3'><font color='red'>大图尺寸：1920*599</font></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td colspan='3'><input type="submit" value="确定添加"/>&nbsp;&nbsp;<input onclick="clickform()" type="button" value="重新填写"/></td>
