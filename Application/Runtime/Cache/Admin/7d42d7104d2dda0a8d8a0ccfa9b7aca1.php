	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">关于我们栏目添加</h3>
						</div>
					...
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Addcompany/add.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>中文名称：</td>
								<td colspan='2'><input type="text" size="50" name="cm_name"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>关键字：</td>
								<td colspan='2'><input type="text" size="30" name="cm_keys"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>中文内容：</td>
								<td colspan='2'><textarea name="cm_content"></textarea></td>
							</tr>
							...
							<tr align="left">
								<td>English名称：</td>
								<td colspan='2'><input type="text" size="50" name="encm_name"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>English内容：</td>
								<td colspan='2'><textarea name="encm_content"></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'><input type="submit" value="添加栏目"/>&nbsp;&nbsp;<input onclick="clickform()" type="button" value="重新填写"/></td>
							</tr>
						</table>
						</form>
				    </div>
