...
<script type="text/javascript">
	...
	KindEditor.ready(function(e){
		editor=e.create('[name=cm_content]',{
			'width':"800px",
			'height':'100px'
		});
		eneditor=e.create('[name=encm_content]',{
			'width':"800px",
			'height':'100px'
		});
	})
	function tijiao(){
		if(document.frm.cm_name.value==''){
			alert("栏目名称不能为空！");
			document.frm.cm_name.focus();
			return false;
		}else if(editor.html()==''){
			alert("文章内容不能为空！");
			editor.focus();
			return false;
		}else if(document.frm.encm_name.value==''){
			alert("English栏目名称不能为空！");
			document.frm.encm_name.focus();
			return false;
	...
	function tuichu(){
		location="/index.php/Admin/Modcompany/index.html";
	}
</script>
</head>
<body>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">关于我们栏目修改</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Modcompany/index.html"  class="btn btn-secondary btn-lo pull-right">查看所有栏目</a>
                            </div>
						<div class="clearfix" style="margin-bottom:8px;"></div> 
					</div>
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Modcompany/save/cmid/<?php echo ($company["cm_id"]); ?>.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>栏目名称：</td>
								<td colspan='2'><input type="text" size="50" name="cm_name" value="<?php echo ($company["cm_name"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>关键字：</td>
								<td colspan='2'><input type="text" size="30" name="cm_keys" value="<?php echo ($company["cm_keys"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>文章内容：</td>
								<td colspan='2'><textarea name="cm_content"><?php echo ($company["cm_content"]); ?></textarea></td>
							</tr>
							<tr><td colspan='3'>&nbsp;</td></tr>
							<tr><td colspan='3'>*************English部分*************</td></tr>
							<tr><td colspan='3'>&nbsp;</td></tr>
							<tr align="left">
								<td>栏目名称：</td>
								<td colspan='2'><input type="text" size="50" name="encm_name" value="<?php echo ($company["encm_name"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>文章内容：</td>
								<td colspan='2'><textarea name="encm_content"><?php echo ($company["encm_content"]); ?></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'><input type="submit" value="确定修改栏目"/>&nbsp;&nbsp;<input onclick="tuichu()" type="button" value="退出编辑"/></td>
							</tr>
						</table>
						</form>
				    </div>
