...
<script type="text/javascript">
	...
	KindEditor.ready(function(e){
		editor=e.create('[name=g_content]',{
			'width':"800px",
			'height':'100px'
		});
		eneditor=e.create('[name=eng_content]',{
			'width':"800px",
			'height':'100px'
		});
	})
	function tijiao(){
		if(document.frm.g_name.value==''){
			alert("中文概述标题不能为空！");
			document.frm.g_name.focus();
			return false;
		}else if(document.frm.eng_name.value==''){
			alert("English概述标题不能为空！");
			document.frm.eng_name.focus();
			return false;
		}else if(editor.html()==''){
			alert("中文概述内容不能为空！");
			editor.focus();
	...
	function tuichu(){
		window.location="/index.php/Admin/Modgaishu/index.html";
	}
</script>
</head>
<body>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">产品概述修改</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Modgaishu/index.html"  class="btn btn-secondary btn-lo pull-right">查看所有产品概述</a>
                            </div>
						<div class="clearfix" style="margin-bottom:8px;"></div> 
					</div>
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Modgaishu/save/gid/<?php echo ($gaishu["g_id"]); ?>.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>概述标题：</td>
								<td colspan='2'><textarea name="g_name" cols="50" rows="1"><?php echo ($gaishu["g_name"]); ?></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>英文标题：</td>
								<td colspan='2'><textarea name="eng_name" cols="50" rows="1"><?php echo ($gaishu["eng_name"]); ?></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>图片上传</td>
								<td>中文图片：<input id='tupian' type="file" name="upload[]" multiple="multiple"/></td>
								
								<td>
									english图片：<input id='tupian' type="file" name="enupload[]" multiple="multiple"/>
								</td>
								<td></td>
							</tr>
							<tr>
							...
							<tr align="left">
								<td>已有图片：</td>
								<td>
									<?php if($gaishu["g_picture"] != null): ?><img src="/Public/images/<?php echo ($gaishu["g_picture"]); ?>" title="" alt="" width="100" height="80"/>
									<?php else: ?>
										<img src="/Public/images/wutu.png" title="" alt="" width="100" height="80"/><?php endif; ?>
								</td>
								<td>
									<?php if($gaishu["eng_picture"] != null): ?><img src="/Public/images/<?php echo ($gaishu["eng_picture"]); ?>" title="" alt="" width="100" height="80"/>
									<?php else: ?>
										<img src="/Public/images/wutu.png" title="" alt="" width="100" height="80"/><?php endif; ?>
								</td>
							</tr>
							...
							<tr>
								<td>文章内容：</td>
								<td colspan='2'><textarea name="g_content"><?php echo ($gaishu["g_content"]); ?></textarea></td>
							</tr>
							<tr>
								<td colspan='3'>&nbsp;</td>
							</tr>
							<tr>
								<td>English内容：</td>
								<td colspan='2'><textarea name="eng_content"><?php echo ($gaishu["eng_content"]); ?></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
