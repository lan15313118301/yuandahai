...
<script type="text/javascript">
	...
	KindEditor.ready(function(e){
		editor=e.create('[name=co_content]',{
			'width':"800px",
			'height':'200px'
		})
	})
	function tijiao(){
		if(document.frm.co_name.value==''){
			alert("概述标题不能为空！");
	...
	function tuichu(){
		window.location="/index.php/Admin/Modcooperation/index.html";
	}
</script>
</head>
<body>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">修改合作伙伴</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Modcooperation/index.html"  class="btn btn-secondary btn-lo pull-right">查看所有合作伙伴</a>
                            </div>
						<div class="clearfix" style="margin-bottom:8px;"></div> 
					</div>
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Modcooperation/save/coid/<?php echo ($cooperation["co_id"]); ?>.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>概述标题：</td>
								<td colspan='2'><input type="text" size="30" name="co_name" value="<?php echo ($cooperation["co_name"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								...
								<td>已有图片：</td>
								<td>
								<?php if($cooperation["co_picture"] != '0'): ?><img src="/Public/images/<?php echo ($cooperation["co_picture"]); ?>" title="" alt="" width="100" height="80"/>
								<?php else: ?>
							...
							<tr>
								<td>文章内容：</td>
								<td colspan='2'><textarea name="co_content"><?php echo ($cooperation["co_content"]); ?></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
