	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">发布招聘信息</h3>
						</div>
					...
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Addjob/add.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>招聘岗位：</td>
								<td colspan='2'><input type="text" size="50" name="j_name"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>关键字：</td>
								<td colspan='2'><input type="text" size="30" name="j_keys"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>岗位要求：</td>
								<td colspan='2'><textarea name="j_content"></textarea></td>
							</tr>
							...
							<tr align="left">
								<td>English职位名称：</td>
								<td colspan='2'><input type="text" size="50" name="enj_name"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>English职位需求：</td>
								<td colspan='2'><textarea name="enj_content"></textarea></td>
							</tr>
							<tr><td colspan='3'>&nbsp;</td></tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'><input type="submit" value="发布招聘"/>&nbsp;&nbsp;<input onclick="clickform()" type="button" value="重新填写"/></td>
							</tr>
						</table>
						</form>
				    </div>
