...
<script type="text/javascript">
	function del($co_id){
		if(confirm("确定要删除此条合作伙伴吗？")){
			window.location="/index.php/Admin/Modcooperation/del/coid/"+$co_id;
		}
	}
	function getNum(){
	...
	function alldel(){
		...
		window.frm.action="/index.php/Admin/Modcooperation/delall";
		document.frm.submit();
	}
	function showpai(){
	...
	function allpai(){
		window.frm.action="/index.php/Admin/Modcooperation/allpai";
		document.frm.submit();
	}
</script>
</head>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">所有合作伙伴</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Addcooperation/index.html"  class="btn btn-secondary btn-lo pull-right">添加合作伙伴</a>
                            </div>
							...
							<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
									...
									<form name="frm" id='frm' action='' method="post">
										<table class="table table-striped">
											...
											<tbody>
											<?php if(is_array($cooperation)): foreach($cooperation as $key=>$v): ?><tr>
													<td><input type="checkbox" name="news[]" onclick='newsdel()' value="<?php echo ($v["co_id"]); ?>"/></td>
													<td><?php echo ($v["co_id"]); ?></td>
													<td><input type="text" size="2"  onchange='showpai()' name="paixu[<?php echo ($v["co_id"]); ?>]" value="<?php echo ($v["co_pai"]); ?>"/></td>
													<td><?php echo (cutstr($v["co_name"],10)); ?></td>
													<td>
													<?php if($v["co_picture"] != '0'): ?><img src='/public/images/<?php echo ($v["co_picture"]); ?>' alt='' title='' width="80" height="40"/><?php endif; ?>	
													</td>
													<td><?php echo (date('Y-m-d H:m',$v["co_time"])); ?></td>
													<?php if($v["co_upttime"] == null): ?><td>无</td>
													<?php else: ?>
														<td><?php echo (date('Y-m-d H:m',$v["co_upttime"])); ?></td><?php endif; ?>
													<td>
														<a href="/index.php/Admin/Modcooperation/upt/cooperationId/<?php echo ($v["co_id"]); ?>.html" class="btn btn-default btn-sm btn-lo">修改</a>
                                          				  <a href="#" onclick="del(<?php echo ($v["co_id"]); ?>)" class="btn btn-default btn-sm btn-lo">删除</a>
													</td>
