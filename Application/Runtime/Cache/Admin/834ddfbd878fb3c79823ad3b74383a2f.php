...
<script type="text/javascript">
	function del($g_id){
		if(confirm("确定要删除此条产品概述吗？")){
			window.location="/index.php/Admin/Modgaishu/del/gid/"+$g_id;
		}
	}
	function getNum(){
	...
	function alldel(){
		...
		window.frm.action="/index.php/Admin/Modgaishu/delall";
		document.frm.submit();
	}
	function showpai(){
	...
	function allpai(){
		window.frm.action="/index.php/Admin/Modgaishu/allpai";
		document.frm.submit();
	}
</script>
</head>
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						...
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Addgaishu/index.html"  class="btn btn-secondary btn-lo pull-right">添加产品概述</a>
                            </div>
							...
							<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
									...
									<form name="frm" id='frm' action='' method="post">
										<table class="table table-striped">
											...
											<tbody>
											<?php if(is_array($gaishu)): foreach($gaishu as $key=>$v): ?><tr>
													<td><input type="checkbox" name="news[]" onclick='newsdel()' value="<?php echo ($v["g_id"]); ?>"/></td>
													<td><?php echo ($v["g_id"]); ?></td>
													<td><input type="text" size="2"  onchange='showpai()' name="paixu[<?php echo ($v["g_id"]); ?>]" value="<?php echo ($v["g_pai"]); ?>"/></td>
													<td><?php echo (cutstr($v["g_name"],27)); ?></td>
													<td>
													<?php if($v["g_picture"] != '0'): ?><img src='/public/images/<?php echo ($v["g_picture"]); ?>' alt='' title='' width="80" height="40"/><?php endif; ?>	
													</td>
													<td><?php echo (cutstr($v["eng_name"],27)); ?></td>
													<td>
													<?php if($v["eng_picture"] != '0'): ?><img src='/public/images/<?php echo ($v["eng_picture"]); ?>' alt='' title='' width="80" height="40"/><?php endif; ?>	
													</td>
													<td><?php echo (date('Y-m-d H:m',$v["g_time"])); ?></td>
													<td>
														<a href="/index.php/Admin/Modgaishu/upt/gaishuId/<?php echo ($v["g_id"]); ?>" class="btn btn-default btn-sm btn-lo">修改</a>
                                          				  <a href="#" onclick="del(<?php echo ($v["g_id"]); ?>)" class="btn btn-default btn-sm btn-lo">删除</a>
													</td>
