...
<script type="text/javascript">
	...
	function tuichu(){
		location="/index.php/Admin/Modcate/index.html";
	}
</script>
</head>
<body>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
					...
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Modcate/save/cateId/<?php echo ($cate["c_id"]); ?>.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>&nbsp;</td>
								<td>中文种类名称：</td>
								<td colspan='2'><input type="text" size="40" name="c_name" value="<?php echo ($cate["c_name"]); ?>"/></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr align="left">
								...
								<td>English种类名称：</td>
								<td colspan='2'>
									<input type="text" size="40" name="enc_name" value="<?php echo ($cate["enc_name"]); ?>"/>
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
