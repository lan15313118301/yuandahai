...
<script type="text/javascript">
	function tijiao(){
		if(document.frm.c_name.value==''){
			alert("产品种类名称不能为空！");
			document.frm.c_name.focus();
			return false;
		}else if(document.frm.enc_name.value==''){
			alert("产品种类English名称不能为空！");
			document.frm.enc_name.focus();
			return false;
		}
	}
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">产品种类添加</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Modcate/index.html"  class="btn btn-secondary btn-lo pull-right">查看所有种类</a>
                            </div>
						<div class="clearfix" style="margin-bottom:8px;"></div> 
					</div>
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Addcate/add.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>&nbsp;</td>
								<td>种类名称：</td>
								<td colspan='2'><input type="text" size="25" name="c_name"/></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<!--由于客户需求，不需要详细页了，所有默认都是列表页。不改动数据库的前提下，所以将其隐藏。-->
							<tr align="left" style="display:none;">
								<td>&nbsp;</td>
								<td>所属分类：</td>
								<td colspan='2'>
								<input type="radio" name="c_cate" value="列表页" checked/>列表页
								&nbsp;&nbsp;
								<input type="radio" name="c_cate" value="详细页"/>详细页
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td colspan='5'>****************英文部分**************</td>
							</tr><tr>
								<td>&nbsp;</td>
								<td colspan='4'>&nbsp;</td>
							</tr>
							<tr align="left">
								<td>&nbsp;</td>
								<td>English名称：</td>
								<td colspan='2'><input type="text" size="25" name="enc_name"/></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td style="margin-left:0px"><input type="submit" value="添加种类"/>&nbsp;&nbsp;<input onclick="clickform()" type="button" value="重新填写"/></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
						</table>
