...
<script type="text/javascript">
	function tuichu(){
		location="/index.php/Admin/Modbanner/index.html";
	}
</script>
</head>
<body>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">首页面大图添加</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Modbanner/index.html"  class="btn btn-secondary btn-lo pull-right">查看所有大图</a>
                            </div>
						<div class="clearfix" style="margin-bottom:8px;"></div> 
					</div>
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Modbanner/save/bid/<?php echo ($banner["b_id"]); ?>.html" method="post" enctype="multipart/form-data">
						<table>
							<tr align="left">
								<td>中文大图修改：</td>
							...
							<tr align="left">
								<td>显示中文大图：</td>
								<td colspan='2'><img src='/public/images/<?php echo ($banner["b_picture"]); ?>' alt='' title='' width="600" height="200"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>英文大图修改：</td>
								<td colspan='2'><input id='tupian' type="file" name="enupload[]" multiple="multiple"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>显示英文大图：</td>
								<td colspan='2'><img src='/public/images/<?php echo ($banner["enb_picture"]); ?>' alt='' title='' width="600" height="200"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
