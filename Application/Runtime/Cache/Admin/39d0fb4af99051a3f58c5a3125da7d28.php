	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">发布产品</h3>
						</div>
					...
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Addpro/add.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
						<tr align="left">
								<td>所属分类1：</td>
								<td colspan='2'>
							...
							<tr align="left">
								<td>关键字：</td>
								<td colspan='2'><textarea rows="1" cols="40" name="p_keys"></textarea></td>
							</tr>
							<tr>
								<td colspan='3'>&nbsp;</td>
							</tr>
							...
							<tr align="left">
								<td>产品标题：</td>
								<td colspan='2'><input type="text" size="50" name="p_name"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>一句话简介：</td>
								<td colspan='2'><textarea rows="1" cols="70" name="p_intro"></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>产品介绍：</td>
								<td colspan='2'><textarea name="p_content"></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>English标题：</td>
								<td colspan='2'><input type="text" size="50" name="enp_name"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>English简介：</td>
								<td colspan='2'><textarea rows="1" cols="70" name="enp_intro"></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>English介绍：</td>
								<td colspan='2'><textarea name="enp_content"></textarea></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'><input type="submit" value="发布产品"/>&nbsp;&nbsp;<input onclick="clickform()" type="button" value="重新填写"/></td>
							</tr>
						</table>
						</form>
				    </div>
