...
<script type="text/javascript">
	...
	KindEditor.ready(function(e){
		editor=e.create('[name=q_content]',{
			'width':"800px",
			'height':'200px'
		});
		eneditor=e.create('[name=enq_content]',{
			'width':"800px",
			'height':'200px'
		});
	})
	function tijiao(){
		if(document.frm.q_name.value==''){
			alert("栏目名称不能为空！");
			document.frm.q_name.focus();
			return false;
		}else if(editor.html()==''){
			alert("文章内容不能为空！");
			editor.focus();
			return false;
		}else if(document.frm.enq_name.value==''){
			alert("English栏目名称不能为空！");
			document.frm.enq_name.focus();
			return false;
	...
	function tuichu(){
		location="/index.php/Admin/Modqita/index.html";
	}
</script>
</head>
<body>
	...
	function nologin(){
	    ...
	    <div id="page-wrapper">
		        <div class="graphs">
		        	<div>
						<div class="clearfix">
							<h3 class="content-title">项目栏目修改</h3>
						</div>
						<div class="description" ><?php echo ($msg["role"]); ?></div>
						<div class="col-sm-12">
                                <a href="/index.php/Admin/Modqita/index.html"  class="btn btn-secondary btn-lo pull-right">查看所有栏目</a>
                            </div>
						<div class="clearfix" style="margin-bottom:8px;"></div> 
					</div>
					<div class="copy">
						<!-- 网站内容 -->
						<form name="frm" action="/index.php/Admin/Modqita/save/qid/<?php echo ($qita["q_id"]); ?>.html" method="post" enctype="multipart/form-data" onsubmit="return tijiao()">
						<table>
							<tr align="left">
								<td>栏目名称：</td>
								<td colspan='2'><input type="text" size="50" name="q_name" value="<?php echo ($qita["q_name"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr align="left">
								<td>关键字：</td>
								<td colspan='2'><input type="text" size="30" name="q_keys" value="<?php echo ($qita["q_keys"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>文章内容：</td>
								<td colspan='2'><textarea name="q_content"><?php echo ($qita["q_content"]); ?></textarea></td>
							</tr>
							...
							<tr align="left">
								<td>English栏目名称：</td>
								<td colspan='2'><input type="text" size="50" name="enq_name" value="<?php echo ($qita["enq_name"]); ?>"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td colspan='2'>&nbsp;</td>
							...
							<tr>
								<td>English文章内容：</td>
								<td colspan='2'><textarea name="enq_content"><?php echo ($qita["enq_content"]); ?></textarea></td>
							</tr>
							<tr><td colspan='3'>&nbsp;</td></tr>
							<tr>
								<td>&nbsp;</td>
